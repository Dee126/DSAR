...
export const NAV_ITEMS: NavItemDef[] = [
  ...
  },
  {
    label: "Intake Inbox",
    href: "/intake",
    requiresRole: ["SUPER_ADMIN", "TENANT_ADMIN", "DPO", "CASE_MANAGER", "ANALYST", "AUDITOR", "CONTRIBUTOR"],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    requiresRole: ["SUPER_ADMIN", "TENANT_ADMIN", "DPO", "CASE_MANAGER"],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    ...
    requiresRole: ["SUPER_ADMIN", "TENANT_ADMIN", "DPO", "CASE_MANAGER", "ANALYST", "AUDITOR"],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  },
  {
    label: "eDiscovery",
    href: "/ediscovery",
    requiresRole: ["SUPER_ADMIN", "TENANT_ADMIN", "DPO", "AUDITOR"],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
  ...
  {
    label: "Delivery",
    href: "/governance/delivery",
    requiresRole: ["SUPER_ADMIN", "TENANT_ADMIN", "DPO"],
    icon: (
      <svg className="h-5 w-5" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
