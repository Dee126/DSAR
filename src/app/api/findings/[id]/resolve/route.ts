...
import { findingResolveSchema } from "@/lib/validation";
 ...
 * Transitions status: MITIGATING → MITIGATED
 * Requires a comment confirming the mitigation is complete.
 */
export async function POST(
  ...
  try {
    ...
    const data = findingResolveSchema.parse(body);
