...
-- CreateEnum
CREATE TYPE "FindingStatus" AS ENUM ('NEW', 'ACCEPTED', 'MITIGATED');
...
-- CreateEnum
CREATE TYPE "CaseItemDecision" AS ENUM ('PROPOSED', 'INCLUDED', 'EXCLUDED');
...
CREATE TABLE "dsar_case_items" (
    ...
    "dataCategory" TEXT,
    "riskScore" INTEGER,
    "decision" "CaseItemDecision" NOT NULL DEFAULT 'PROPOSED',
    "decisionReason" TEXT,
    ...
    CONSTRAINT "dsar_case_items_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "dsar_audit_events" (
    "id" TEXT NOT NULL,
    "tenantId" TEXT NOT NULL,
    "caseId" TEXT NOT NULL,
    "actorUserId" TEXT,
    ...
    CONSTRAINT "dsar_audit_events_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "data_assets" (
    ...
    "sensitivityScore" INTEGER NOT NULL DEFAULT 0,
...
-- CreateIndex
CREATE INDEX "findings_tenantId_systemId_idx" ON "findings"("tenantId", "systemId");
...
-- CreateIndex
CREATE INDEX "dsar_case_items_tenantId_caseId_idx" ON "dsar_case_items"("tenantId", "caseId");

-- CreateIndex
CREATE INDEX "dsar_audit_events_tenantId_caseId_idx" ON "dsar_audit_events"("tenantId", "caseId");

-- CreateIndex
CREATE INDEX "data_assets_tenantId_idx" ON "data_assets"("tenantId");

-- CreateIndex
CREATE INDEX "data_assets_tenantId_systemId_idx" ON "data_assets"("tenantId", "systemId");

-- CreateIndex
CREATE INDEX "scan_jobs_tenantId_idx" ON "scan_jobs"("tenantId");

-- CreateIndex
CREATE INDEX "scan_jobs_tenantId_systemId_idx" ON "scan_jobs"("tenantId", "systemId");
...
-- AddForeignKey
ALTER TABLE "tasks" ADD CONSTRAINT "tasks_findingId_fkey" FOREIGN KEY ("findingId") REFERENCES "findings"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "findings" ADD CONSTRAINT "findings_systemId_fkey" FOREIGN KEY ("systemId") REFERENCES "systems"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "findings" ADD CONSTRAINT "findings_statusChangedByUserId_fkey" FOREIGN KEY ("statusChangedByUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "dsar_cases"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_findingId_fkey" FOREIGN KEY ("findingId") REFERENCES "findings"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_evidenceId_fkey" FOREIGN KEY ("evidenceId") REFERENCES "evidence_items"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_systemId_fkey" FOREIGN KEY ("systemId") REFERENCES "systems"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_case_items" ADD CONSTRAINT "dsar_case_items_decidedByUserId_fkey" FOREIGN KEY ("decidedByUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_audit_events" ADD CONSTRAINT "dsar_audit_events_tenantId_fkey" FOREIGN KEY ("tenantId") REFERENCES "tenants"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_audit_events" ADD CONSTRAINT "dsar_audit_events_caseId_fkey" FOREIGN KEY ("caseId") REFERENCES "dsar_cases"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "dsar_audit_events" ADD CONSTRAINT "dsar_audit_events_actorUserId_fkey" FOREIGN KEY ("actorUserId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "data_assets" ADD CONSTRAINT "data_assets_systemId_fkey" FOREIGN KEY ("systemId") REFERENCES "systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE "scan_jobs" ADD CONSTRAINT "scan_jobs_systemId_fkey" FOREIGN KEY ("systemId") REFERENCES "systems"("id") ON DELETE CASCADE ON UPDATE CASCADE;
